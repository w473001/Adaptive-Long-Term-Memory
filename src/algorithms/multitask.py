...
class MultiTaskAlgo:
    ...
    def __init__(self, algo_name, algo_config, global_config):
        ...
        global_config_['n_switches'] = (global_config_.get('n_switches_per_epoch') + 1) * global_config_.get('n_epochs') - 1
        ...
        # global_config_['small_pool'] = global_config_.get('epoch_pool_size')
        logger.info(f"small pool for multitask algo = {global_config_['small_pool']}")
